	<div id="js_register_step1">
		...
		<div class="table">
			<div class="table_right">                           
				<input placeholder="{phrase var='user.choose_a_username'}" type="text" name="val[user_name]" id="user_name" title="{phrase var='user.your_username_is_used_to_easily_connect_to_your_profile'}" value="{value type='input' id='user_name'}" size="30" autocomplete="off" />
